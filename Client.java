...
public class Client extends Thread{
    ...
    public void receiveTransactions(Transactions transact)
    {
        ...
        while (i < getNumberOfTransactions())
        {
            while (objNetwork.getOutBufferStatus().equals("empty") &&
                ...
                Thread.yield(); // Wait until the output buffer has data
            }

            if (objNetwork.getOutBufferStatus().equals("empty") &&
                    objNetwork.getClientConnectionStatus().equals("disconnected")) {
                break; // Exit if the client is disconnected and buffer is empty
    ...
    public void run()
    {
        ...
        if (clientOperation.equals("sending")) {
            objNetwork.setClientConnectionStatus("connected");
