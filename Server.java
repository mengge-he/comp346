...
public class Server extends Thread{
    ...
    {   int accIndex;             	/* Index position of account to update */
        ...
        while ((!objNetwork.getClientConnectionStatus().equals("disconnected")))
        {
            ...
            { if(objNetwork.getClientConnectionStatus().equals("disconnected"))break; else{Thread.yield();}}  /* Alternatively, busy-wait until the network input buffer is available */
            ...
            if (!objNetwork.getInBufferStatus().equals("empty"))
            {
                ...
                while( (objNetwork.getOutBufferStatus().equals("full"))){ if(objNetwork.getClientConnectionStatus().equals("disconnected"))break; else{Thread.yield();}}; /* Alternatively,  busy-wait until the network output buffer is available */
    ...
    {   Transactions trans = new Transactions();
        ...
        //transaction is sent from client
        while (!(objNetwork.getClientConnectionStatus().equals("disconnected"))) {

            // Process the transactions from the buffer
